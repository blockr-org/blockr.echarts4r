...
#' @method server_output e_legend_toggle_select_block
#' @export
...
#' @method uiOutputBlock e_legend_toggle_select_block
#' @export
...
#' @method evaluate_block e_legend_toggle_select_block
#' @export
...
#' @method generate_server e_legend_toggle_select_block
#' @export
...
#' @method block_combiner e_legend_toggle_select_block
#' @export
