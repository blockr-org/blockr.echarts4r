...
#' @method server_output e_theme_register_block
#' @export
...
#' @method uiOutputBlock e_theme_register_block
#' @export
...
#' @method evaluate_block e_theme_register_block
#' @export
...
#' @method generate_server e_theme_register_block
#' @export
...
#' @method block_combiner e_theme_register_block
#' @export
