...
#' @method server_output e_image_g_block
#' @export
...
#' @method uiOutputBlock e_image_g_block
#' @export
...
#' @method evaluate_block e_image_g_block
#' @export
...
#' @method generate_server e_image_g_block
#' @export
...
#' @method block_combiner e_image_g_block
#' @export
