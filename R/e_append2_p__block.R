...
#' @method server_output e_append2_p__block
#' @export
...
#' @method uiOutputBlock e_append2_p__block
#' @export
...
#' @method evaluate_block e_append2_p__block
#' @export
...
#' @method generate_server e_append2_p__block
#' @export
...
#' @method block_combiner e_append2_p__block
#' @export
