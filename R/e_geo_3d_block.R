new_e_geo_3d_block <- function(data, ...){
  blockr::new_block(
    name = "e_geo_3d_block",
    expr = quote(
      echarts4r::e_geo_3d(
    ...
    class = c("e_geo_3d_block", "echarts_layer_block")
  )
}
...
#' @method server_output e_geo_3d_block
#' @export
...
#' @export
evaluate_block.e_geo_3d_block <- function (x, data, ...) 
{
    stopifnot(...length() == 0L)
...
#' @method generate_server e_geo_3d_block
#' @export
generate_server.e_geo_3d_block <- function (...) 
{
    blockr:::generate_server_block(...)
}

#' @method block_combiner e_geo_3d_block
#' @export
block_combiner.e_geo_3d_block <- function (left, right, ...) 
{
