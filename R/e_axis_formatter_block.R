...
#' @method server_output e_axis_formatter_block
#' @export
...
#' @method uiOutputBlock e_axis_formatter_block
#' @export
...
#' @method evaluate_block e_axis_formatter_block
#' @export
...
#' @method generate_server e_axis_formatter_block
#' @export
...
#' @method block_combiner e_axis_formatter_block
#' @export
