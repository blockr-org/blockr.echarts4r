...
#' @method server_output e_angle_axis__block
#' @export
...
#' @method uiOutputBlock e_angle_axis__block
#' @export
...
#' @method evaluate_block e_angle_axis__block
#' @export
...
#' @method generate_server e_angle_axis__block
#' @export
...
#' @method block_combiner e_angle_axis__block
#' @export
