new_e_effect_scatter_block <- function(data, ...){
  blockr::new_block(
    name = "e_effect_scatter_block",
    expr = quote(
    ...
    class = c("e_effect_scatter_block", "echarts_layer_block")
  )
}

#' @export
e_effect_scatter_block <- function(data, ...){
